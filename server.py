...
class StravaAPI:
    ...
    async def get_activities(self, limit: int = 200, sport_type: Optional[str] = None):
        ...
        print(f"🔍 Fetching activities from 2022 to now...", file=sys.stderr)
...
class SimpleMCPServer:
    ...
    def __init__(self):
        self.tools = [
            {
                "name": "get_activities",
                "description": "Retrieve user's Strava activities from 2022 to now",
                "parameters": {
            ...
            },
            {
                ...
                "description": "Get summary statistics for all activities including longest activity from 2022 to now",
                "parameters": {}
            }
        ]
