...
\input{2_Tables/tab_sota_comparison}
...
Tables~\ref{tab:stability}--\ref{tab:usability} give the reporting structures of the four evaluation levels of Section~\ref{sec:evaluation}: component and API stability, robustness scenarios, the conversation-quality scoring dimensions and aggregate results, and the usability study. Result cells are placeholders (\textbf{TBD}) pending the final runs.
...
\input{1_Figures/fig_ux_participants}

\input{1_Figures/fig_ux_tech}

\input{1_Figures/fig_ux_sus}

\input{1_Figures/fig_corpus_usage}
...
\input{1_Figures/fig_screenshot_coach}

\input{1_Figures/fig_screenshot_flythrough}

\input{1_Figures/fig_screenshot_telegram}
