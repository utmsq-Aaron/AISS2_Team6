...
\caption[Complete MCP tool inventory (1/2)]{Complete MCP tool inventory (part 1 of 2): weather, routes, and Strava.}\label{tab:full_tools}
...
\begin{center}
\begin{minipage}{\textwidth}
\caption[Complete MCP tool inventory (2/2)]{Complete MCP tool inventory (part 2 of 2): Garmin, calendar, flythrough, and Google Maps.}\label{tab:full_tools_b}
\begin{tabularx}{\textwidth}{lllX}
\toprule
\textbf{Server} & \textbf{Port} & \textbf{Tool Name} & \textbf{Description} \\
\midrule
