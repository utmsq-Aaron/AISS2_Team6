...
\addlinespace
LLM: KIT AI Gateway & Chat completion; default backend for every agent and specialist & API key from the course gateway & N/A---consumed directly, not MCP-wrapped & \texttt{core/llm.py}, OpenAI-compatible client \\
\addlinespace
LLM: OpenAI (official) & Chat completion; alternate backend & API key from platform.openai.com & N/A---consumed directly, not MCP-wrapped & \texttt{core/llm.py}, same client, official base URL \\
\addlinespace
