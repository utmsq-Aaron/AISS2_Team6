...
\caption[Evaluation scoring dimensions]{Evaluation scoring dimensions. The four conversational dimensions are rated per conversation by an LLM judge (GPT-5.4-nano). The fifth is a deterministic scorer that inspects tool-call traces directly.}\label{tab:scorers}
