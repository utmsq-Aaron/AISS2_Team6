...
\begin{tikzpicture}[
    ...
    \node[block, draw=tcgreen, fill=tcgreen!8, right=1.2cm of query] (embed) {Embed\\{\scriptsize all-MiniLM-L6-v2}};
    \node[block, draw=tccyan, fill=tccyan!8, right=1.8cm of embed] (store) {Cosine Search\\{\scriptsize (N$\times$384 float32)}};
    \node[block, draw=tcyellow!80!black, fill=tcyellow!8, right=1.4cm of store] (topk) {Top-$k$\\Passages};
    ...
    \node[data, draw=tcgrey!40, fill=tcgrey!4, below=0.4cm of store] (corpus) {5 textbooks, $\sim$11k chunks};
